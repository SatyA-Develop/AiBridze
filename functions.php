...
function aibridze_render_opportunity_meta_box( WP_Post $post ): void {
	...
	?>
	<p><label for="aibridze-opportunity-experience"><strong><?php esc_html_e( 'Experience', 'aibridze' ); ?></strong></label></p>
	<p><input class="widefat" id="aibridze-opportunity-experience" name="aibridze_opportunity_experience" type="text" value="<?php echo esc_attr( $experience ); ?>" placeholder="3–4 Years"></p>
	<p><label for="aibridze-opportunity-location"><strong><?php esc_html_e( 'Location', 'aibridze' ); ?></strong></label></p>
	<p><input class="widefat" id="aibridze-opportunity-location" name="aibridze_opportunity_location" type="text" value="<?php echo esc_attr( $location ); ?>" placeholder="Remote (IN)"></p>
	<p><label for="aibridze-opportunity-department"><strong><?php esc_html_e( 'Department', 'aibridze' ); ?></strong></label></p>
	<p><input class="widefat" id="aibridze-opportunity-department" name="aibridze_opportunity_department" type="text" value="<?php echo esc_attr( $department ); ?>" placeholder="Engineering"></p>
	<p><label for="aibridze-opportunity-type"><strong><?php esc_html_e( 'Employment Type', 'aibridze' ); ?></strong></label></p>
	<p><select class="widefat" id="aibridze-opportunity-type" name="aibridze_opportunity_type"><option value="Full-time"<?php selected( $type, 'Full-time' ); ?>>Full-time</option><option value="Part-time"<?php selected( $type, 'Part-time' ); ?>>Part-time</option><option value="Contract"<?php selected( $type, 'Contract' ); ?>>Contract</option><option value="Internship"<?php selected( $type, 'Internship' ); ?>>Internship</option></select></p>
	<p class="description"><?php esc_html_e( 'Use the title for the role name and the main WordPress editor for the complete rich job description, including headings, paragraphs, ordered lists and unordered lists.', 'aibridze' ); ?></p>
	<?php
}
...
function aibridze_seed_opportunities(): void {
	...
	$roles = array(
		array( 'Associate UI/UX Designer', '3–4 Years', 'Remote (IN)', 'Design' ), array( 'Senior Business Development Executive', '5–8 Years', 'Remote (IN)', 'Sales' ),
		array( 'WordPress Developer', '1–3 Years', 'Remote (IN)', 'Engineering' ), array( 'Data Analyst', '2–4 Years', 'Hybrid (CA)', 'Data' ),
		array( 'Mobile App Developer', '1–3 Years', 'Remote (UK)', 'Engineering' ), array( 'Senior React Developer', '4–7 Years', 'Noida (IN)', 'Engineering' ),
		array( 'Node.js Backend Engineer', '3–6 Years', 'Remote (IN)', 'Engineering' ), array( 'Machine Learning Engineer', '3–5 Years', 'Hybrid (IN)', 'AI & ML' ),
		array( 'Generative AI Engineer', '2–5 Years', 'Remote (US)', 'AI & ML' ), array( 'DevOps Engineer', '3–6 Years', 'Noida (IN)', 'Cloud' ),
		array( 'Cloud Solutions Architect', '6–10 Years', 'Remote (AE)', 'Cloud' ), array( 'Quality Assurance Engineer', '2–4 Years', 'Remote (IN)', 'Quality' ),
		array( 'Flutter Developer', '2–5 Years', 'Remote (IN)', 'Engineering' ), array( 'Product Manager', '5–8 Years', 'Hybrid (IN)', 'Product' ),
		array( 'Technical Project Manager', '6–9 Years', 'Remote (UK)', 'Delivery' ), array( 'Cybersecurity Engineer', '3–6 Years', 'Remote (US)', 'Security' ),
		array( 'Automation Test Engineer', '2–5 Years', 'Noida (IN)', 'Quality' ), array( 'SEO Specialist', '2–4 Years', 'Remote (IN)', 'Marketing' ),
		array( 'Content Marketing Specialist', '2–5 Years', 'Remote (IN)', 'Marketing' ), array( 'Solutions Consultant', '4–7 Years', 'Hybrid (AE)', 'Consulting' ),
		array( 'Python Developer', '2–5 Years', 'Remote (IN)', 'Engineering' ), array( 'AI Research Intern', '0–1 Year', 'Noida (IN)', 'AI & ML' ),
		array( 'Frontend Engineering Intern', '0–1 Year', 'Remote (IN)', 'Engineering' ), array( 'Database Administrator', '4–7 Years', 'Hybrid (CA)', 'Data' ),
...
function aibridze_render_leader_meta_box( WP_Post $post ): void {
	...
	<p><input class="widefat" id="aibridze-leader-position" name="aibridze_leader_position" type="text" value="<?php echo esc_attr( $position ); ?>" placeholder="<?php esc_attr_e( 'Co-Founder & Director', 'aibridze' ); ?>"></p>
	<p><label for="aibridze-leader-linkedin"><strong><?php esc_html_e( 'LinkedIn URL', 'aibridze' ); ?></strong></label></p>
	<p><input class="widefat" id="aibridze-leader-linkedin" name="aibridze_leader_linkedin" type="url" value="<?php echo esc_attr( $linkedin ); ?>" placeholder="https://www.linkedin.com/in/..."></p>
	<p class="description"><?php esc_html_e( 'Use the title field for the leader name, Featured Image for the portrait, and Order to control the display order.', 'aibridze' ); ?></p>
	<?php
}
...
function aibridze_render_team_meta_box( WP_Post $post ): void {
	...
	<p><input class="widefat" id="aibridze-team-position" name="aibridze_team_position" type="text" value="<?php echo esc_attr( $position ); ?>" placeholder="<?php esc_attr_e( 'Software Engineer', 'aibridze' ); ?>"></p>
	<p class="description"><?php esc_html_e( 'Use the title field for the member name, Featured Image for the portrait, and Order to control the display order.', 'aibridze' ); ?></p>
	<?php
}
...
function aibridze_render_blog_takeaways_meta_box( WP_Post $post ): void {
	...
	?><p class="description"><?php esc_html_e( 'Supports Visual and Code editing, headings, bold text, links, and lists. This field is also exposed through the WordPress REST API for Elementor integrations.', 'aibridze' ); ?></p><?php
}
...
function aibridze_service_category_image_field( ?WP_Term $term = null ): void {
	...
	<div class="form-field aibridze-icon-field" data-service-icon-field>
		...
		<img class="aibridze-icon-field__preview" src="<?php echo esc_url( $image_url ); ?>" width="187" height="190" alt="" style="display:block;object-fit:cover;margin:8px 0;">
		<input type="hidden" name="aibridze_category_image_id" value="<?php echo esc_attr( $image_id ); ?>" data-service-icon-input>
		<button class="button" type="button" data-service-icon-select><?php esc_html_e( 'Choose image', 'aibridze' ); ?></button>
...
add_action( 'service_category_add_form_fields', static function (): void { aibridze_service_category_image_field(); } );
add_action( 'service_category_edit_form_fields', static function ( WP_Term $term ): void { ?><tr class="form-field"><th scope="row"></th><td><?php aibridze_service_category_image_field( $term ); ?></td></tr><?php } );
...
function aibridze_render_service_icon_meta_box( WP_Post $post ): void {
	...
	<div class="aibridze-icon-field" data-service-icon-field>
		<img class="aibridze-icon-field__preview" src="<?php echo esc_url( $icon_url ?: get_theme_file_uri( '/assets/images/service-icon-default.png' ) ); ?>" width="48" height="48" alt="">
		<input type="hidden" name="aibridze_service_icon_id" value="<?php echo esc_attr( $icon_id ); ?>" data-service-icon-input>
		<p>
			<button class="button" type="button" data-service-icon-select><?php esc_html_e( 'Choose icon', 'aibridze' ); ?></button>
		...
		<p class="description"><?php esc_html_e( 'Recommended: square PNG or SVG. Displayed at 24×24px in the mega menu.', 'aibridze' ); ?></p>
	</div>
	<?php
}
...
function aibridze_render_testimonial_meta_box( WP_Post $post ): void {
	...
	?>
	<p><label for="aibridze-testimonial-role"><strong><?php esc_html_e( 'Job title', 'aibridze' ); ?></strong></label><br><input class="widefat" id="aibridze-testimonial-role" name="aibridze_testimonial_role" value="<?php echo esc_attr( $role ); ?>"></p>
	<p><label for="aibridze-testimonial-company"><strong><?php esc_html_e( 'Company', 'aibridze' ); ?></strong></label><br><input class="widefat" id="aibridze-testimonial-company" name="aibridze_testimonial_company" value="<?php echo esc_attr( $company ); ?>"></p>
	<div class="aibridze-icon-field" data-service-icon-field>
		<p><strong><?php esc_html_e( 'Company logo', 'aibridze' ); ?></strong></p>
		<img class="aibridze-icon-field__preview" src="<?php echo esc_url( $logo ?: get_theme_file_uri( '/assets/images/consultation/company-logo.png' ) ); ?>" width="120" height="54" alt="">
		<input type="hidden" name="aibridze_testimonial_logo_id" value="<?php echo esc_attr( $logo_id ); ?>" data-service-icon-input>
		<p><button class="button" type="button" data-service-icon-select><?php esc_html_e( 'Choose logo', 'aibridze' ); ?></button> <button class="button-link-delete" type="button" data-service-icon-remove<?php echo $logo_id ? '' : ' hidden'; ?>><?php esc_html_e( 'Remove', 'aibridze' ); ?></button></p>
	</div>
	<?php
}
...
function aibridze_render_portfolio_meta_box( WP_Post $post ): void {
	...
	<div class="aibridze-icon-field" data-service-icon-field>
		...
		<img class="aibridze-icon-field__preview" src="<?php echo esc_url( $logo ); ?>" width="140" height="60" alt="" style="object-fit:contain;background:#171719;padding:8px;">
		<input type="hidden" name="aibridze_portfolio_logo_id" value="<?php echo esc_attr( $logo_id ); ?>" data-service-icon-input>
		<p><button class="button" type="button" data-service-icon-select><?php esc_html_e( 'Choose logo', 'aibridze' ); ?></button> <button class="button-link-delete" type="button" data-service-icon-remove<?php echo $logo_id ? '' : ' hidden'; ?>><?php esc_html_e( 'Remove', 'aibridze' ); ?></button></p>
	</div>
	<p><label><strong><?php esc_html_e( 'Statistic one', 'aibridze' ); ?></strong></label><br><input class="widefat" name="aibridze_portfolio_stat_one" value="<?php echo esc_attr( get_post_meta( $post->ID, '_aibridze_portfolio_stat_one', true ) ); ?>" placeholder="$52M"></p>
	<p><label><strong><?php esc_html_e( 'Statistic one label', 'aibridze' ); ?></strong></label><br><input class="widefat" name="aibridze_portfolio_stat_one_label" value="<?php echo esc_attr( get_post_meta( $post->ID, '_aibridze_portfolio_stat_one_label', true ) ); ?>" placeholder="Raised in Funding"></p>
	<p><label><strong><?php esc_html_e( 'Statistic two', 'aibridze' ); ?></strong></label><br><input class="widefat" name="aibridze_portfolio_stat_two" value="<?php echo esc_attr( get_post_meta( $post->ID, '_aibridze_portfolio_stat_two', true ) ); ?>" placeholder="500k+"></p>
	<p><label><strong><?php esc_html_e( 'Statistic two label', 'aibridze' ); ?></strong></label><br><input class="widefat" name="aibridze_portfolio_stat_two_label" value="<?php echo esc_attr( get_post_meta( $post->ID, '_aibridze_portfolio_stat_two_label', true ) ); ?>" placeholder="New Users Acquired"></p>
	<p><label><strong><?php esc_html_e( 'Project URL', 'aibridze' ); ?></strong></label><br><input class="widefat" type="url" name="aibridze_portfolio_url" value="<?php echo esc_attr( get_post_meta( $post->ID, '_aibridze_portfolio_url', true ) ); ?>" placeholder="https://"></p>
	<?php
}
...
function aibridze_save_portfolio( int $post_id ): void {
	...
	if ( ! wp_verify_nonce( $nonce, 'aibridze_save_portfolio' ) || ! current_user_can( 'edit_post', $post_id ) ) return;
	update_post_meta( $post_id, '_aibridze_portfolio_logo_id', absint( $_POST['aibridze_portfolio_logo_id'] ?? 0 ) );
	foreach ( array( 'stat_one', 'stat_one_label', 'stat_two', 'stat_two_label' ) as $field ) update_post_meta( $post_id, '_aibridze_portfolio_' . $field, sanitize_text_field( wp_unslash( $_POST[ 'aibridze_portfolio_' . $field ] ?? '' ) ) );
...
function aibridze_seed_site_content(): void {
	...
	foreach ( $industries as $industry_order => $industry_name ) {
		...
		if ( ! is_wp_error( $industry_id ) && ! has_post_thumbnail( $industry_id ) ) {
			...
			if ( $image_id ) set_post_thumbnail( $industry_id, $image_id );
		}
	}
...
function aibridze_country_calling_codes(): array {
	return array(
		'AF' => '+93', 'AL' => '+355', 'DZ' => '+213', 'AS' => '+1684', 'AD' => '+376', 'AO' => '+244', 'AI' => '+1264', 'AQ' => '+672', 'AG' => '+1268', 'AR' => '+54',
		'AM' => '+374', 'AW' => '+297', 'AU' => '+61', 'AT' => '+43', 'AZ' => '+994', 'AX' => '+35818', 'BS' => '+1242', 'BH' => '+973', 'BD' => '+880', 'BB' => '+1246', 'BY' => '+375',
		'BE' => '+32', 'BZ' => '+501', 'BJ' => '+229', 'BM' => '+1441', 'BT' => '+975', 'BO' => '+591', 'BQ' => '+599', 'BA' => '+387', 'BW' => '+267', 'BV' => '+47',
		'BR' => '+55', 'IO' => '+246', 'BN' => '+673', 'BG' => '+359', 'BF' => '+226', 'BI' => '+257', 'CV' => '+238', 'KH' => '+855', 'CM' => '+237', 'CA' => '+1',
		'KY' => '+1345', 'CF' => '+236', 'TD' => '+235', 'CL' => '+56', 'CN' => '+86', 'CX' => '+61', 'CC' => '+61', 'CO' => '+57', 'KM' => '+269', 'CG' => '+242',
		'CD' => '+243', 'CK' => '+682', 'CR' => '+506', 'CI' => '+225', 'HR' => '+385', 'CU' => '+53', 'CW' => '+599', 'CY' => '+357', 'CZ' => '+420', 'DK' => '+45',
		'DJ' => '+253', 'DM' => '+1767', 'DO' => '+1809', 'EC' => '+593', 'EG' => '+20', 'SV' => '+503', 'GQ' => '+240', 'ER' => '+291', 'EE' => '+372', 'SZ' => '+268',
		'ET' => '+251', 'FK' => '+500', 'FO' => '+298', 'FJ' => '+679', 'FI' => '+358', 'FR' => '+33', 'GF' => '+594', 'PF' => '+689', 'TF' => '+262', 'GA' => '+241',
		'GM' => '+220', 'GE' => '+995', 'DE' => '+49', 'GH' => '+233', 'GI' => '+350', 'GR' => '+30', 'GL' => '+299', 'GD' => '+1473', 'GP' => '+590', 'GU' => '+1671',
		...
		'JM' => '+1876', 'JP' => '+81', 'JE' => '+44', 'JO' => '+962', 'KZ' => '+7', 'KE' => '+254', 'KI' => '+686', 'KP' => '+850', 'KR' => '+82', 'KW' => '+965',
		...
		'MU' => '+230', 'YT' => '+262', 'MX' => '+52', 'FM' => '+691', 'MD' => '+373', 'MC' => '+377', 'MN' => '+976', 'ME' => '+382', 'MS' => '+1664', 'MA' => '+212',
		'MZ' => '+258', 'MM' => '+95', 'NA' => '+264', 'NR' => '+674', 'NP' => '+977', 'NL' => '+31', 'NC' => '+687', 'NZ' => '+64', 'NI' => '+505', 'NE' => '+227',
		'NG' => '+234', 'NU' => '+683', 'NF' => '+672', 'MK' => '+389', 'MP' => '+1670', 'NO' => '+47', 'OM' => '+968', 'PK' => '+92', 'PW' => '+680', 'PS' => '+970',
		'PA' => '+507', 'PG' => '+675', 'PY' => '+595', 'PE' => '+51', 'PH' => '+63', 'PN' => '+64', 'PL' => '+48', 'PT' => '+351', 'PR' => '+1787', 'QA' => '+974',
		'RE' => '+262', 'RO' => '+40', 'RU' => '+7', 'RW' => '+250', 'BL' => '+590', 'SH' => '+290', 'KN' => '+1869', 'LC' => '+1758', 'MF' => '+590', 'PM' => '+508',
		'VC' => '+1784', 'WS' => '+685', 'SM' => '+378', 'ST' => '+239', 'SA' => '+966', 'SN' => '+221', 'RS' => '+381', 'SC' => '+248', 'SL' => '+232', 'SG' => '+65',
		'SX' => '+1721', 'SK' => '+421', 'SI' => '+386', 'SB' => '+677', 'SO' => '+252', 'ZA' => '+27', 'GS' => '+500', 'SS' => '+211', 'ES' => '+34', 'LK' => '+94',
		'SD' => '+249', 'SR' => '+597', 'SJ' => '+47', 'SE' => '+46', 'CH' => '+41', 'SY' => '+963', 'TW' => '+886', 'TJ' => '+992', 'TZ' => '+255', 'TH' => '+66',
		'TL' => '+670', 'TG' => '+228', 'TK' => '+690', 'TO' => '+676', 'TT' => '+1868', 'TN' => '+216', 'TR' => '+90', 'TM' => '+993', 'TC' => '+1649', 'TV' => '+688',
		'UG' => '+256', 'UA' => '+380', 'AE' => '+971', 'GB' => '+44', 'US' => '+1', 'UM' => '+1', 'UY' => '+598', 'UZ' => '+998', 'VU' => '+678', 'VE' => '+58',
		'VN' => '+84', 'VG' => '+1284', 'VI' => '+1340', 'WF' => '+681', 'EH' => '+212', 'YE' => '+967', 'ZM' => '+260', 'ZW' => '+263',
	);
}
